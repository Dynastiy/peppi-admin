<template>
    <div>
      <div class="tw-flex tw-justify-between tw-items-center">
        <h5 class="tw-mb-1 tw-font-semibold">Shipping</h5>
      ...
      <div class="tw-mt-5">
        <b-skeleton-wrapper :loading="busy">
          ...
          <div class="tw-flex tw-flex-col tw-gap-3">
            ...
            >
              ...
              Add Pickup Location
                ...
                /></span>
                <span class="tw-text-green-600" role="button" @click="view(item)"
          ...
          <div v-if="items.length === 0">
            <h6 class="tw-text-red-600 tw-font-normal tw-text-sm">No items found</h6>
          </div>
        </b-skeleton-wrapper>
      </div>
